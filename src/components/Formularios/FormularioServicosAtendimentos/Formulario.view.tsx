...
export default function FormularioView(props: { setOpen: any }): React.ReactElement {
    ...
    const { addServicoAtendimento, deleteServicoAtendimento } = useServicosAtendimentosContext();

...
export default function DialogFormularioServicos(props: { addServicoAtendimento: any; }): React.ReactElement {
                ...
                <div >
                    ...
                    <div style={{
                        ...
                        >
                            ...
                            <FormularioView setOpen={setOpen} addServicoAtendimento={props.addServicoAtendimento} />
                        </Box>
                    </div>
                </div>
            </Dialog>
